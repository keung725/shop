    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <form class="form" id="upload" enctype="multipart/form-data" method="post" action="{{ url('admin/brands/'.$Brand->id)}}" autocomplete="off">
                        <div id="success_message"></div>
                        <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                        <div class="form-group">
                            <label>Brand Image</label>
                            <img id="image_banner" src="{{ URL::asset($Brand->image_path)}}" class="img-responsive" style="width:250px;"/>
